...
=======
BATCH_SIZE = 16
>>>>>>> 5ab2b3f1037a827d2e484ad4466c1d1e13ae4645
...
for epoch in range(EPOCHS):
    ...
    if (epoch % 10 == 0):
        grid_num = round(BATCH_SIZE / 2)
        fig = plt.figure(figsize=(grid_num,grid_num))
        plt.axis("off")
        ims = [ [plt.imshow(np.transpose(i,(1,2,0)))] for i in img_list]
        plt.savefig(f"/home/ladvien/Desktop/images/{epoch}.png")
        plt.show()
